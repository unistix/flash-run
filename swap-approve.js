...
async function runFlash(_params) {
    ...
    const flashTx = await flashLoanContract.connect(connectedWallet).createFlashLoan(_params.token0, convertToContractValue(BORROW, 18),params, {gasLimit: ethers.utils.hexlify(500000), //this is optimum gas for approval
    gasPrice: ethers.utils.parseUnits("120", "gwei")}) //use a buffer tracker tbh
