...
const poolNumber = 41  //pool being tested from list of pools 51 DAI 31USDC 41USDT 1CRV
const BORROW = 1
/**
...
async function runFlash(_params) {
    ...
    const flashLoanContract = new ethers.Contract(flashLoanContractAdress, FlashLoanExampleABI.abi, signer)
